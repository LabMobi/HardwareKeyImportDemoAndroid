 ...
 */
@ThreadSafe
public class TeeDirectDecrypter extends DirectCryptoProvider implements JWEDecrypter, CriticalHeaderParamsAware {
    ...
    private final SecretKey teeHardwareKey;


    /**
     * Creates a new direct decrypter.
     *
     * @param teeHardwareKey Android TEE hardware key
     * @param fakeKey        placeholder key to pass checks at parents
     * @throws KeyLengthException If the symmetric key length is not
     *                            compatible.
     */
    public TeeDirectDecrypter(final SecretKey teeHardwareKey, final SecretKey fakeKey)
            throws KeyLengthException {

        this(teeHardwareKey, fakeKey, false);
    }
     ...
     *                            compatible.
     */
    public TeeDirectDecrypter(final SecretKey teeHardwareKey, final SecretKey key, final boolean promiscuousMode)
            throws KeyLengthException {

        super(key);
        this.teeHardwareKey = teeHardwareKey;
        this.promiscuousMode = promiscuousMode;
    }

    @Override
    public SecretKey getKey() {
        return teeHardwareKey;
    }
    ...
    public byte[] decrypt(final JWEHeader header,
        ...
        return decrypt(header, null, iv, cipherText, authTag, getKey(), getJCAContext());
    }
